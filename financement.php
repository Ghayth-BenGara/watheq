...
<html lang = "en">
    <head>
		...
		<title>Financement et versements | سوق واثق</title>
	...
	<body>
        ...
        <div class = "banner_inner banner_inner_5 d-flex align-items-center">
            ...
            <div class = "banner_content text-center">
                <h2>Financement et versements</h2>
                <div class = "page_link">
                <a href = "index.php">Accueil</a>
                <a href = "javascript: void(0)">Catégorie </a>
                <a href = "financement.php">Financement et versements</a>
                </div>
            </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            function filter_data(page){
                ...
                var type = 'Financement et versement';
                var tri = get_filter_tri('tri');
                var table = 'article_plus';
                var email_like = "<?php echo $email_like;?>";
                
                $.ajax({
                    url:"php/fonctions.php",
                    method:"POST",
                    data:{action:action, type:type, table:table,tri:tri,page:page,email:email_like,actionFilterData:'filter'},
