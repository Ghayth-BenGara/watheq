<?php
  ...
  $row2 = getInformationProfil($_GET['email']);
  if(testCompteGet($_GET['email']) == "compte non existe"){
...
<html lang = "en">   
	<head>
		...
		<title><?php echo $row2['nom']; ?> | سوق واثق</title>
		...
		<style>
			...
			#team .card{
				border-radius:0;
				box-shadow: 5px 5px 15px rgb(241, 245, 247);
				transition:all 0.3s ease-in;
				-webkit-transition:all 0.3s ease-in;
				-moez-transition:all 0.3s ease-in;
			}
        		...
        		<div class = "container">
          			<div class = "banner_content text-center">
            			...
            			<div class = "page_link">
							...
							<a href = "informations.php?email=<?php echo $_GET['email'];?>">Informations</a>
            			</div>
          			</div>
        		</div>
      		</div>
                    					...
                    					<div class = "blog_details">
                      						<div class = "row">
                        						<div class = "col-lg-12 col-md-12">
													<?php informationsVendeurApresNotification($_GET['email'],$_SESSION['email']);?>
                        						</div>
                      						</div>
                    					</div>
                  					</div>
         			...
         			<div class = "col-lg-4">
            			<div class = "blog_right_sidebar">
							...
							<aside class = "single_sidebar_widget popular_post_widget">
          					...
          					<aside class = "load" id = "load"></aside>
        				</div>
      				</div>
    			</div>
  			</div>
