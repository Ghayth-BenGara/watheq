...
<html lang = "en">
    <head>
		...
		<title>Matériaux | سوق واثق</title>
                        ...
                        <div class = "left_sidebar_area">
							...
							<aside class = "left_widgets p_filter_widgets">
								...
								<div class = "widgets_inner">
									...
									<ul class = "list">
										<li>
											<label><input type = "checkbox" class = "common_selector nom" value = "APPLE">APPLE</label>
										</li>
										<li>
											<label><input type = "checkbox" class = "common_selector nom" value = "HTC">HTC</label>
										</li>
										<li>
											<label><input type = "checkbox" class = "common_selector nom" value = "HUAWEI">HUAWEI</label>
										</li>
										<li>
											<label><input type = "checkbox" class = "common_selector nom" value = "M8">M8</label>
										</li>
										<li>
											<label><input type = "checkbox" class = "common_selector nom" value = "NOKIA">NOKIA</label>
										</li>
										<li>
											<label><input type = "checkbox" class = "common_selector nom" value = "SAMSUNG">SAMSUNG</label>
										</li>
										<li>
											<label><input type = "checkbox" class = "common_selector nom" value = "SONY">SONY</label>
										</li>
										<li>
											<label><input type = "checkbox" class = "common_selector nom" value = "TOSHIBA">TOSHIBA</label>
										</li>
									</ul>
								</div>
							</aside>
