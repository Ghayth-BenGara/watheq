...
<html lang = "en">   
  <head>
    ...
    <title>Journal d'authentification | سوق واثق</title>
        ...
        <div class = "container">
          <div class = "banner_content text-center">
            ...
            <div class = "page_link">
              ...
              <a href = "journal_authentification.php?email=<?php echo $_SESSION['email'];?>">Journal d'authentification</a>
            </div>
          </div>
        </div>
      </div>
                      ...
                      <div class = "row">
                        <div class = "col-lg-12 col-md-12">
                          <div class = "section-top-border">
                            <h3 class = "mb-30 title_color text-center">Journal d'authentification</h3>
                            <a href = " javascript:void(0)" id = "remove_journal" onclick = "return deleteJournal(`<?php echo $_SESSION['email'];?>`)"><i class = "lnr lnr-trash"></i></a>
                            <div class = "progress-table-wrap">
                              <div class = "progress-table">
                                <?php getJournal($_SESSION['email']); ?>
                              </div>
                            </div>
                          </div>
                        </div>
