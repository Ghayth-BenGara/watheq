...
<html lang = "en">   
  <head>
    ...
    <title>Réactions | سوق واثق</title>
  ...
  <body>
    ...
    <section class = "banner_area">
      <div class = "banner_inner banner_inner_10 d-flex align-items-center">
        <div class = "container">
          <div class = "banner_content text-center">
            ...
            <div class = "page_link">
              ...
              <a href = "reactions.php?email=<?php echo $_SESSION['email'];?>">Réactions</a>
            </div>
          </div>
        </div>
      </div>
                      ...
                      <div class = "row">
                        <div class = "col-lg-12 col-md-6">
                            <div class = "section-top-border">
				                <h3 class = "mb-30 title_color">Historique des réactions</h3>
				                <div class = "row">
						            <blockquote class = "generic-blockquote">
                          <?php getHistoriqueReaction($_SESSION['email']);?>
                        </blockquote>
				                </div>
			                </div> 
                        </div>
              ...
              <form method = "POST" action = "javascript: void(0)" onsubmit = "return desabonner()">
                <div class = "form-group d-flex flex-row">
                  <div class = "input-group">
                    ...
                    <input type = "email" class = "form-control email" id = "email" placeholder = "Saisissez votre e-mail.." required name = "email" value = "<?php echo $_SESSION['email'];?>">
                  </div>
